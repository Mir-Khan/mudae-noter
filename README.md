...
- Pick colors visually with a color wheel on the **Colors** tab, scoped to your keyed characters, with detailed/compact/grid views (showing kakera value) and a "No Color Only" filter to find who's still missing one.
